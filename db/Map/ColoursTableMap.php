...
class ColoursTableMap extends TableMap
{
     ...
     */
    const COL_DESCRIPTION = 'colours.description';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Colour', 'Code', 'Description', ),
        self::TYPE_CAMELNAME     => array('colour', 'code', 'description', ),
        self::TYPE_COLNAME       => array(ColoursTableMap::COL_COLOUR, ColoursTableMap::COL_CODE, ColoursTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('colour', 'code', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Colour' => 0, 'Code' => 1, 'Description' => 2, ),
        self::TYPE_CAMELNAME     => array('colour' => 0, 'code' => 1, 'description' => 2, ),
        self::TYPE_COLNAME       => array(ColoursTableMap::COL_COLOUR => 0, ColoursTableMap::COL_CODE => 1, ColoursTableMap::COL_DESCRIPTION => 2, ),
        self::TYPE_FIELDNAME     => array('colour' => 0, 'code' => 1, 'description' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ColoursTableMap::COL_DESCRIPTION);
        } else {
